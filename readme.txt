...
I highly recommend starting with H.264 video and AAC audio in an MP4 container. If you're encoding with Handbrake, make sure that "Web Optimized" is checked. Using Apple's Compressor, the "Streaming" setting should be "Fast Start" (not Fast Start - Compressed Header). I've written up my recommended video encode settings in http://www.kylegilman.net/2011/02/25/making-mp4-h-264-videos-in-apple-compressor a post on my website</a>.
